...
export default function ProfessorLayout() {
  ...
  const navLinks = [
    ...
    { to: "/professor/ranking", label: "Ranking", icon: "M2 8h20 M12 2v20 M7 2l5 6 M17 2l-5 6", exact: false },
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-3 border-l border-gray-100 pl-5">
              <div className="w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center text-sm font-bold">
                 {perfil?.nome?.charAt(0) || "P"}
              </div>
              <span className="text-sm font-semibold text-gray-700 hidden md:block">Prof. {perfil?.nome?.split(' ')[0] || "Ana Silva"}</span>
