    ...
    <div className="min-h-screen bg-[#F8F9FA] text-gray-700">
      <header className="bg-white border-b border-gray-100 px-6 py-3 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-2 text-sm font-medium text-gray-500">
          <NavLink to="/coordenacao" end className={({ isActive }) => `px-4 py-2 rounded-xl transition-all ${isActive ? "bg-emerald-50 text-emerald-700 font-semibold" : "hover:bg-gray-50 hover:text-gray-800"}`}>
            📊 Painel
          </NavLink>
          <NavLink to="/coordenacao/relatorios" className={({ isActive }) => `px-4 py-2 rounded-xl transition-all ${isActive ? "bg-emerald-50 text-emerald-700 font-semibold" : "hover:bg-gray-50 hover:text-gray-800"}`}>
            📈 Relatórios
          </NavLink>
        </nav>
